// filepath: d:\NOI Software\new project - reboot home\Reboot-L2G\frontend\src\pages\L2gServices.jsx

import React from 'react';

import Navbar from '../components/Navbar';
import Footer from '../components/Footer';
import { FaCalendarAlt, FaGlobeAmericas, FaLeaf, FaHandsHelping, FaHotel } from 'react-icons/fa';

export default function L2gServices() {
    return (
        <div>
            <Navbar />
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col items-center justify-center p-6 text-center">
                <div className="max-w-3xl w-full bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-8 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="flex justify-center mb-6">
                                <FaCalendarAlt className="text-6xl text-white drop-shadow-lg" />
                            </div>
                            <h1 className="text-4xl font-bold mb-2">Coming Soon</h1>
                            <p className="text-xl mb-6">
                                We're preparing amazing new services for you!
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">
                            Exciting L2G Services Are On The Way
                        </h2>

                        <p className="text-gray-600 mb-8">
                            We're curating exceptional travel experiences and services that will be available soon.
                            Our team is carefully designing new features to bring you the best possible adventures and support.
                        </p>

                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                <FaGlobeAmericas className="text-2xl text-blue-500 mx-auto mb-2" />
                                <p className="text-sm font-medium">Global Destinations</p>
                            </div>
                            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                <FaLeaf className="text-2xl text-green-500 mx-auto mb-2" />
                                <p className="text-sm font-medium">Eco-Friendly Options</p>
                            </div>
                            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                            ...
                            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                <FaHotel className="text-2xl text-purple-500 mx-auto mb-2" />
                ...
                <div className="mt-8 text-gray-500 text-sm">
                    <p>Have suggestions for our upcoming services? Contact our travel experts!</p>
                </div>
            </div>
            <Footer />
        </div>
